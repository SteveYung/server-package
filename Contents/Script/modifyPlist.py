...
#Embedded file name: /Projects/GitLab/rsdk_package/Env/Script/modifyPlist.py
...
class PlistWriter(object):
    ...
    def writeObject(self, obj, output, setReferencePosition = False):
        ...
        if obj is None:
            ...
            output += proc_variable_length(6, len(byteData) // 2)
            output += byteData
